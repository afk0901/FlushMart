...
class CustomerProduct(models.Model):
    warranty = models.OneToOneField('CustomerProductWarranty',
                        on_delete=models.CASCADE, 
                        related_name='customer_product_warranty')
    category = models.ForeignKey('CustomerProductCategory',
                        on_delete=models.CASCADE, 
...
class CustomerProductFeature(models.Model):
    customer_product_feature_section = models.ForeignKey('CustomerProduct', 
                        on_delete=models.CASCADE, 
